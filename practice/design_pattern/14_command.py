...
# print(CommandNumber.LIGTH.value)
# print(CommandNumber.GAME.value)
# print(len(CommandNumber))
...
remote_controller.set_command(CommandNumber.LIGTH.value, light_on_command, light_off_command)
...
remote_controller.on_command(CommandNumber.LIGTH.value)
remote_controller.off_command(CommandNumber.LIGTH.value)
