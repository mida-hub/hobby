       ...
       .then(async function ([
           ...
           renderBtn.addEventListener('click', () => {
               ...
               let wasmResult = null;
               {
                   ...
                   const draw_elaspsed = drawEndTime - drawStartTime;
                   console.log(`\tgenerate:wasm\tgenerate_elaspsed:${elapsed}[ms]`);
                   console.log(`\tdraw: js\tdraw_elapsed: ${draw_elaspsed}[ms]`);
               }
           })
       })
