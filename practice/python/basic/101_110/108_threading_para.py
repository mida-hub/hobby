...
def upload_image(file_path):
    ...
    return f'http://upload_{file_path}'
...
download_worker = Worker(download_image, download_queue, process_queue, len(urls))
process_worker = Worker(process_image, process_queue, upload_queue, len(urls))
upload_worker = Worker(upload_image, upload_queue, done_queue, len(urls))
...
logging.info(f'処理終了 = {done_queue.queue}')