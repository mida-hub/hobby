...
func (x *GetMyCatMessage) Reset() {
	*x = GetMyCatMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pb_cat_proto_msgTypes[0]
...
func (*GetMyCatMessage) Descriptor() ([]byte, []int) {
	return file_pb_cat_proto_rawDescGZIP(), []int{0}
}
...
func (x *MyCatResponse) Reset() {
	*x = MyCatResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pb_cat_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MyCatResponse) Descriptor() ([]byte, []int) {
	return file_pb_cat_proto_rawDescGZIP(), []int{1}
}
...
var File_pb_cat_proto protoreflect.FileDescriptor

var file_pb_cat_proto_rawDesc = []byte{
	0x0a, 0x0c, 0x70, 0x62, 0x2f, 0x63, 0x61, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x30,
...
var (
	file_pb_cat_proto_rawDescOnce sync.Once
	file_pb_cat_proto_rawDescData = file_pb_cat_proto_rawDesc
)

func file_pb_cat_proto_rawDescGZIP() []byte {
	file_pb_cat_proto_rawDescOnce.Do(func() {
		file_pb_cat_proto_rawDescData = protoimpl.X.CompressGZIP(file_pb_cat_proto_rawDescData)
	})
	return file_pb_cat_proto_rawDescData
}

var file_pb_cat_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pb_cat_proto_goTypes = []interface{}{
	(*GetMyCatMessage)(nil), // 0: GetMyCatMessage
	(*MyCatResponse)(nil),   // 1: MyCatResponse
}
var file_pb_cat_proto_depIdxs = []int32{
...
func init() { file_pb_cat_proto_init() }
func file_pb_cat_proto_init() {
	if File_pb_cat_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_pb_cat_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pb_cat_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_pb_cat_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_pb_cat_proto_goTypes,
		DependencyIndexes: file_pb_cat_proto_depIdxs,
		MessageInfos:      file_pb_cat_proto_msgTypes,
	}.Build()
	File_pb_cat_proto = out.File
	file_pb_cat_proto_rawDesc = nil
	file_pb_cat_proto_goTypes = nil
	file_pb_cat_proto_depIdxs = nil
}
